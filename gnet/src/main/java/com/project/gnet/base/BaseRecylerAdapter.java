 ...
 */
public abstract class BaseRecylerAdapter<T> extends RecyclerView.Adapter<BaseRecylerViewHolder> implements View.OnLongClickListener, View.OnClickListener {
    ...
    public BaseRecylerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        BaseRecylerViewHolder holder = new BaseRecylerViewHolder(view);
        return holder;
    }

    @Override
    public final void onBindViewHolder(BaseRecylerViewHolder holder, int position) {
        holder.getHolderView().setTag(position);
        convert(holder, position);
    }

    public abstract void convert(BaseRecylerViewHolder holder, int position);
